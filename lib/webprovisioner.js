...
var WebProvisioner = (function () {
    ...
    WebProvisioner.prototype.onSetup = function () {
    ...
    WebProvisioner.prototype.applyTemplate = function (template, handlers, progressCallback) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.onSetup()];
                    case 1:
                        _a.sent();
                        operations = Object.getOwnPropertyNames(template)
                        ...
                        if (handlers) {
                            operations = operations.filter(function (op) { return handlers.indexOf(op) !== -1; });
                        }
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
