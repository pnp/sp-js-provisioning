    ...
    processFile(web, file, serverRelativeUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let fileAddResult;
                try {
                    fileAddResult = yield folder.files.add(file.Url, blob, file.Overwrite);
                }
                catch (fileAddError) {
                    // Handle fileAddError
                }
                ...
                yield this.processPageListViews(web, file.WebParts, fileAddResult.data.ServerRelativeUrl);
            }
            catch (err) {
                throw err;
            }
