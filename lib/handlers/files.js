    ...
    processFile(web, file, webServerRelativeUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.processProperties(web, pnpFile, file.Properties);
    ...
    processWebParts(file, webServerRelativeUrl, fileServerRelativeUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (file.WebParts && file.WebParts.length > 0) {
                let ctx = new SP.ClientContext(webServerRelativeUrl), spFile = ctx.get_web().getFileByServerRelativeUrl(fileServerRelativeUrl), webPartManager = spFile.getLimitedWebPartManager(SP.WebParts.PersonalizationScope.shared);
                yield this.fetchWebPartContents(file.WebParts, (index, xml) => { file.WebParts[index].Contents.Xml = xml; });
                file.WebParts.forEach(wp => {
                    const webPartXml = util_1.replaceTokens(wp.Contents.Xml);
