...
import { ClientSideWebpart, ClientSidePage } from "@pnp/sp";
...
var ClientSidePages = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, clientSidePages.reduce(function (chain, clientSidePage) { return chain.then(function () { return _this.processClientSidePage(clientSidePage, partDefinitions_1); }); }, Promise.resolve())];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
     ...
     */
    ClientSidePages.prototype.processClientSidePage = function (clientSidePage, partDefinitions) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var page;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ClientSidePage.create(null, clientSidePage.Name, clientSidePage.Title, clientSidePage.PageLayoutType)];
                    case 1:
                        page = _a.sent();
                                ...
                                col.Controls.forEach(function (control) {
                                    ...
                                    if (partDef) {
                                        try {
                                            ...
                                            _super.prototype.log_info.call(_this, "processClientSidePage", "Adding " + partDef.Name + " to client side page " + clientSidePage.Name);
                                            column.addControl(part);
                                        }
                                        catch (error) {
                                            console.log(error);
                                            _super.prototype.log_info.call(_this, "processClientSidePage", "Failed adding part " + partDef.Name + " to client side page " + clientSidePage.Name);
                                        }
                                    }
                                    else {
