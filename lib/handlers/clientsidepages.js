            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, web.addClientSidePage(clientSidePage.Name, clientSidePage.Title)];
                    case 1:
                        page = _a.sent();
                        ...
                        clientSidePage.Sections.forEach(function (s) {
                            ...
                            s.Columns.forEach(function (col) {
                                ...
                                col.Controls.forEach(function (control) {
                                    var controlJsonString = _this.tokenHelper.replaceTokens(JSON.stringify(control));
                                    control = JSON.parse(controlJsonString);
                                    _super.prototype.log_info.call(_this, "processClientSidePage", "Adding " + control.webPartData.title + " to client side page " + clientSidePage.Name);
