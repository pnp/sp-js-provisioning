...
var WebSettings = (function (_super) {
    ...
    function WebSettings(config) {
        return _super.call(this, "WebSettings", config) || this;
    }
    /**
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        Object.keys(settings)
                            .filter(function (key) { return typeof (settings[key]) === "string"; })
                            .forEach(function (key) {
                            var value = replaceUrlTokens(settings[key], _this.config);
