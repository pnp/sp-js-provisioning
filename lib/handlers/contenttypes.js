...
var ContentTypes = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        contentTypeId = this.context.contentTypes[contentType.Name];
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!contentType.FieldRefs) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.processContentTypeFieldRefs(contentType, contentTypeId)];
                    case 3:
                        _a.sent();
                        _a.label = 4;
     ...
     */
    ContentTypes.prototype.processContentTypeFieldRefs = function (contentType, contentTypeId) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var _contentType_1, fieldRefNames, fieldLinks, _a, sender, args;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _contentType_1 = this.jsomContext.web.get_contentTypes().getById(contentTypeId);
                        _contentType_1.set_description(contentType.Description);
                        _contentType_1.set_group(contentType.Group);
                        fieldRefNames = contentType.FieldRefs.map(function (fieldRef) { return fieldRef.Name; });
                        _super.prototype.log_info.call(this, "processContentTypeFieldRefs", "Processing field refs for content type " + contentType.Name + " (" + contentType.ID + ")", { fieldRefs: fieldRefNames });
                        fieldLinks = fieldRefNames.map(function (fieldRefName, i) {
                            var siteField = _this.jsomContext.web.get_fields().getByInternalNameOrTitle(fieldRefName);
                    ...
                    case 2:
                        _a = _b.sent();
                        sender = _a.sender, args = _a.args;
                        _super.prototype.log_info.call(this, "processContentTypeFieldRefs", "Failed to process field refs for content type " + contentType.Name + " (" + contentType.ID + ")", { error: args.get_message() });
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
