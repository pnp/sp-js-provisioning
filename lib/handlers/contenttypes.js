...
var ContentTypes = (function (_super) {
    ...
    ContentTypes.prototype.processContentTypeFieldRefs = function (contentType, contentTypeId) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var _contentType_1, fieldLinks, _a, sender, args;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _super.prototype.log_info.call(this, "processContentTypeFieldRefs", "Processing field refs for content type " + contentType.Name + " (" + contentType.ID + ")");
                        ...
                        fieldLinks = contentType.FieldRefs.map(function (fieldRef, i) {
                            _super.prototype.log_info.call(_this, "processContentTypeFieldRefs", "Processing field ref " + fieldRef.Name + " for content type " + contentType.Name + " (" + contentType.ID + ")");
