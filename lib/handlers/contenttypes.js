            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        contentType.FieldRefs.forEach(function (fieldRef) {
                            ...
                            _contentType_1.get_fieldLinks().add(fieldLinkCreationInformation);
                        });
                        _contentType_1.update(true);
                        return [4 /*yield*/, ExecuteJsomQuery(this.jsomContext, [{ clientObject: _contentType_1 }])];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
