...
var Lists = (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), list = _a.list, data = _a.data;
                        this.context.lists.push(data);
                        if (!lc.ContentTypeBindings) return [3 /*break*/, 3];
    ...
    Lists.prototype.processContentTypeBindings = function (lc, list, contentTypeBindings, removeExisting) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contentTypeBindings.reduce(function (chain, ct) { return chain.then(function (_) { return _this.processContentTypeBinding(lc, list, ct.ContentTypeID); }); }, Promise.resolve())];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, list.Fields.reduce(function (chain, field) { return chain.then(function (_) { return _this.processField(web, list, field); }); }, Promise.resolve())];
                    case 1:
                        _a.sent();
                        _a.label = 2;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.trys.push([5, 8, , 9]);
                        return [4 /*yield*/, list.fields.createFieldAsXml(this.context.replaceTokens(fieldXml))];
                    case 6:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 8]);
                        return [4 /*yield*/, view.get()];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, view.update(lvc.AdditionalSettings)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.processViewFields(view, lvc)];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 8];
                    case 5:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, lvc.ViewFields.reduce(function (chain, viewField) { return chain.then(function (_) { return view.fields.add(viewField); }); }, Promise.resolve())];
                    case 2:
                        _a.sent();
