...
class Lists extends handlerbase_1.HandlerBase {
    ...
    processList(web, lc) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (created) {
                logging_1.Logger.log({ data: list, level: 1 /* Info */, message: `List ${lc.Title} created successfully.` });
            }
            ...
            if (contentTypeBindings) {
                ...
                if (removeExisting) {
                    ...
                    contentTypes.forEach(({ Id: { StringValue: ContentTypeId } }) => {
                        ...
                        if (shouldRemove) {
                            logging_1.Logger.write(`Removing content type ${ContentTypeId} from list ${lc.Title}`, 1 /* Info */);
    ...
    processContentTypeBinding(lc, list, contentTypeID) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                logging_1.Logger.log({ message: `Content Type ${contentTypeID} added successfully to list ${lc.Title}.`, level: 1 /* Info */ });
            }
            catch (err) {
                logging_1.Logger.log({ message: `Failed to add Content Type ${contentTypeID} to list ${lc.Title}.`, level: 2 /* Warning */ });
            }
        });
    }
    /**
    ...
    processField(web, lc, fieldXml) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logging_1.Logger.log({ message: `Processing field ${fieldName} (${fieldDisplayName}) for list ${lc.Title}.`, level: 1 /* Info */, data: fieldAttr });
            ...
            try {
                ...
                yield field.delete();
                logging_1.Logger.log({ message: `Field ${fieldName} (${fieldDisplayName}) successfully deleted from list ${lc.Title}.`, level: 1 /* Info */ });
            }
            catch (err) {
                logging_1.Logger.log({ message: `Field ${fieldName} (${fieldDisplayName}) does not exist in list ${lc.Title}.`, level: 1 /* Info */ });
            }
            // Looks like e.g. lookup fields can't be updated, so we'll need to re-create the field
            try {
                ...
                logging_1.Logger.log({ message: `Field '${fieldDisplayName}' added successfully to list ${lc.Title}.`, level: 1 /* Info */ });
            }
            catch (err) {
                logging_1.Logger.log({ message: `Failed to add field '${fieldDisplayName}' to list ${lc.Title}.`, level: 2 /* Warning */ });
            }
        });
    }
    /**
   ...
   */
    ...
    processFieldRef(web, lc, fieldRef) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                logging_1.Logger.log({ data: fieldRef, level: 1 /* Info */, message: `Field '${fieldRef.ID}' updated for list ${lc.Title}.` });
            }
            catch (err) {
                logging_1.Logger.log({ message: `Failed to update field '${fieldRef.ID}' for list ${lc.Title}.`, data: fieldRef, level: 2 /* Warning */ });
            }
        });
    }
    /**
    ...
    processView(web, lc, lvc) {
        return __awaiter(this, void 0, void 0, function* () {
            logging_1.Logger.log({ message: `Processing view ${lvc.Title} for list ${lc.Title}.`, level: 1 /* Info */ });
            ...
            try {
                ...
                logging_1.Logger.log({ message: `View ${lvc.Title} added successfully to list ${lc.Title}.`, level: 1 /* Info */ });
    ...
    processViewFields(view, lvc) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                logging_1.Logger.log({ message: `Processing view fields for view ${lvc.Title}.`, data: { viewFields: lvc.ViewFields }, level: 1 /* Info */ });
                ...
                logging_1.Logger.log({ message: `View fields successfully processed for view ${lvc.Title}.`, level: 1 /* Info */ });
            }
            catch (err) {
                logging_1.Logger.log({ message: `Failed to process view fields for view ${lvc.Title}.`, level: 1 /* Info */ });
            }
        });
    }
}
