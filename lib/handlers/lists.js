...
var Lists = (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        _a.lists = (_b.sent()).reduce(function (obj, l) {
                            obj[l.Title] = l.Id;
                            return obj;
                        }, {});
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.processContentTypeBindings(lc, listEnsureResult.list, lc.ContentTypeBindings, lc.RemoveExistingContentTypes)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
    ...
    Lists.prototype.processContentTypeBindings = function (lc, list, contentTypeBindings, removeExisting) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, contentTypeBindings.reduce(function (chain, ct) { return chain.then(function () { return _this.processContentTypeBinding(lc, list, ct.ContentTypeID); }); }, Promise.resolve())];
                    case 1:
                        _a.sent();
