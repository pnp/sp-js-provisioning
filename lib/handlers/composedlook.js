...
class ComposedLook extends handlerbase_1.HandlerBase {
    ...
    ProvisionObjects(web, composedLook) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield web.applyTheme(util_1.makeUrlRelative(util_1.replaceUrlTokens(composedLook.ColorPaletteUrl, this.config)), util_1.makeUrlRelative(util_1.replaceUrlTokens(composedLook.FontSchemeUrl, this.config)), composedLook.BackgroundImageUrl ? util_1.makeUrlRelative(util_1.replaceUrlTokens(composedLook.BackgroundImageUrl, this.config)) : null, false);
